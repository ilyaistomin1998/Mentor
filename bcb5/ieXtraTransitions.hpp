...
#include <vcl\Classes.hpp>	// Pascal unit
#include <vcl\SysUtils.hpp>	// Pascal unit
#include <vcl\Messages.hpp>	// Pascal unit
#include <vcl\Windows.hpp>	// Pascal unit
#include <vcl\SysInit.hpp>	// Pascal unit
#include <vcl\System.hpp>	// Pascal unit
